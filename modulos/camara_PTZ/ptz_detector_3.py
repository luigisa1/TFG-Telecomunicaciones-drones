...
class PTZDetector:
    ...
    def detect(self):
        ...
        try:
            results = self.model(self.camera_source,conf=0.2, show=True, classes=(0, 67), stream=True, verbose=False, imgsz=self.size)
    ...
    def comprobar_det_cercana(self, boxes):
        print("Comprobando deteccion cercana")
